...
import { Calendar, Clock, MapPin, Heart, Users, Gift, Music, Camera, Sparkles } from 'lucide-react';
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-slate-800">
      ...
      {/* Hero Section */}
      <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 sm:pt-24">
        {/* Animated Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-1/4 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-slate-200/30 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-1/4 left-1/4 w-48 h-48 sm:w-80 sm:h-80 bg-blue-200/30 rounded-full blur-3xl animate-pulse delay-1000" />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 sm:w-64 sm:h-64 bg-slate-100/40 rounded-full blur-2xl animate-pulse delay-500" />
        </div>
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                    ...
                    >
                      ...
                      <span className="text-slate-600 font-light tracking-widest text-xs sm:text-sm uppercase">Запрошення на Весілля</span>
                      <Sparkles className="w-4 h-4 sm:w-6 sm:h-6 text-slate-600" />
                    </motion.div>
                
                <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-thin text-slate-800 leading-none">
                  <span className="block">{config.data.groomName}</span>
                  <motion.span 
                    initial={{ opacity: 0, scale: 0.5 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ delay: 0.6, type: "spring", stiffness: 200 }}
                    className="text-slate-600 text-3xl sm:text-5xl md:text-6xl font-light"
                  >
                    &
                  </motion.span>
  ...
  <motion.div
    ...
    animate={{ opacity: 1 }}
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1 }}
                className="text-lg sm:text-xl text-slate-600 font-light leading-relaxed max-w-lg mx-auto lg:mx-0"
              >
              ...
              >
                <motion.button
                  ...
                  className="group relative bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-medium shadow-xl transition-all duration-300 overflow-hidden"
                >
      ...
      <motion.div
            ...
            >
                  <div className="relative">
                    {/* Decorative Elements */}
                    <div className="absolute -top-4 -right-4 sm:-top-8 sm:-right-8 w-16 h-16 sm:w-24 sm:h-24 border-2 border-slate-300/50 rounded-full" />
                    <div className="absolute -bottom-4 -left-4 sm:-bottom-8 sm:-left-8 w-20 h-20 sm:w-32 sm:h-32 border border-slate-300/30 rounded-full" />
                    ...
                    <div className="relative z-10">
                      ...
                      {/* Overlay Gradient */}
                      <div className="absolute inset-0 bg-gradient-to-t from-slate-800/10 to-transparent rounded-2xl sm:rounded-3xl" />
                    </div>
                  </div>
            </motion.div>
          </div>
      ...
      {/* Countdown Section */}
      <section id="countdown" className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        {/* Background Pattern */}
          ...
          >
            <div className="space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <span className="text-slate-600 font-light tracking-widest text-xs sm:text-sm uppercase">Зворотний Відлік</span>
                    <Calendar className="w-6 h-6 sm:w-8 sm:h-8 text-slate-600" />
                  </motion.div>
              
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-thin text-slate-800 leading-tight">
                До Нашого
                <span className="block text-slate-600 font-light">Особливого Дня</span>
              </h2>
              ...
              <p className="text-lg sm:text-xl text-slate-600 font-light max-w-2xl mx-auto px-4">
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-slate-200/50 shadow-xl">
      ...
      {/* Location Section */}
      <section id="location" className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0">
          ...
          >
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              >
                ...
                <span className="text-slate-600 font-light tracking-widest text-xs sm:text-sm uppercase">Місце</span>
                <MapPin className="w-6 h-6 sm:w-8 sm:h-8 text-slate-600" />
              </motion.div>
              
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-thin text-slate-800 leading-tight">
                Весілля
                <span className="block text-slate-600 font-light">Місце</span>
              </h2>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              >
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/50 shadow-xl">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl border border-slate-200/50">
                  <iframe
      ...
      {/* Schedule Section */}
      <section id="schedule" className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
          ...
          >
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              >
                ...
                <span className="text-slate-600 font-light tracking-widest text-xs sm:text-sm uppercase">Розклад</span>
                <Clock className="w-6 h-6 sm:w-8 sm:h-8 text-slate-600" />
              </motion.div>
              
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-thin text-slate-800 leading-tight">
                Весілля
                <span className="block text-slate-600 font-light">Розклад</span>
              </h2>
            ...
            <div className="block lg:hidden">
              <div className="relative">
                ...
                <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-slate-300 via-slate-400 to-slate-300 rounded-full" />
                  ...
                  {config.data.agenda.map((event, index) => (
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-shrink-0">
                        <div className="w-12 h-12 bg-white border-4 border-slate-600 rounded-full flex items-center justify-center shadow-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-6 border border-slate-200/50 shadow-lg hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="hidden lg:block relative">
              {/* Timeline Line */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-slate-300/50 via-slate-400/30 to-slate-300/50 rounded-full" />
              ...
              <div className="space-y-16">
                {config.data.agenda.map((event, index) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-slate-600 rounded-full border-4 border-white z-10 shadow-lg" />
                    
                    {/* Content Card */}
                    <div className={`w-5/12 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                      <div className="bg-white/90 backdrop-blur-xl rounded-3xl p-8 border border-slate-200/50 shadow-xl hover:shadow-2xl hover:border-slate-300/50 transition-all duration-300 group">
                        <div className="space-y-4">
      ...
      <section id="gallery" className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0">
          ...
          >
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              >
                ...
                <span className="text-slate-600 font-light tracking-widest text-xs sm:text-sm uppercase">Галерея</span>
                <Camera className="w-6 h-6 sm:w-8 sm:h-8 text-slate-600" />
              </motion.div>
              
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-thin text-slate-800 leading-tight">
                Наша
                <span className="block text-slate-600 font-light">Історія</span>
              </h2>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/50 shadow-xl">
              <PhotoGallery />
            </div>
          </motion.div>
        </div>
      ...
      <section id="details" className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
          ...
          >
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              >
                ...
                <span className="text-slate-600 font-light tracking-widest text-xs sm:text-sm uppercase">Деталі</span>
                <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 text-slate-600" />
              </motion.div>
              
              <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-thin text-slate-800 leading-tight">
                Все, що Вам
                <span className="block text-slate-600 font-light">Потрібно Знати</span>
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-light text-slate-800 group-hover:text-slate-600 transition-colors">Дрес-код</h3>
                  </div>
                  <p className="text-slate-600 font-light leading-relaxed">
                    Запрошуємо напівформальний одяг. Будь ласка, уникайте білих суконь, щоб наречена сяяла.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-slate-600 font-light leading-relaxed">
                    Будь ласка, підтвердіть присутність до 15 травня 2025 року. Не можемо дочекатися святкування з вами!
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-light text-slate-800 group-hover:text-slate-600 transition-colors">Подарунки</h3>
                  </div>
                  <p className="text-slate-600 font-light leading-relaxed">
                    Ваша присутність - найкращий подарунок. Якщо ви хочете подарувати щось, у нас є реєстр подарунків.
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-light text-slate-800 group-hover:text-slate-600 transition-colors">Музика</h3>
                  </div>
                  <p className="text-slate-600 font-light leading-relaxed">
                    У нас буде жива музика та танці. Запрошення пісень вітаються!
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-6"> 
                <h3 className="text-3xl sm:text-4xl font-thin text-white tracking-wider drop-shadow-lg">
                  Viktor & Helen
                </h3> 
            ...
            <div className="pt-6 sm:pt-8 border-t border-white/30">
              <p className="text-white/70 text-sm font-light drop-shadow-md">
                © 2025 Весілля Viktor & Helen. Всі права захищені.
              </p>
            </div>
          </motion.div>
        </div>
